...
<section class="container">
        ...
        <section id="about" class="container about">
            ...
            <div class="abt-content">
                ...
                <p>
                    Lorem ipsum sit dolar imet ipsum sit dolar imet ipsum sit 
                    dolar imet ipsum sit dolar imet ipsum sit dolar imet ipsum 
                    sit dolar imet ipsum sit dolar imet ipsum sit dolar imet
                    Lorem ipsum sit dolar imet ipsum sit dolar imet ipsum sit
                    dolar imet ipsum sit dolar imet ipsum sit dolar imet ipsum 
                    sit dolar imet ipsum sit dolar imet ipsum sit dolar imet
                </p>
        ...
        <section id="projects" class="container projects">
            ...
            <?php 
                        ...
                        ?>
                        <li class="pro-btn"><a href="<?php echo $row['link']?>"><?php echo $row['link_text'];?></a></li>
                        <!-- <li class="pro-btn"><a href=""><?php echo $row['tech'];?></a></li> -->
                        <li class="pro-list">
        ...
        <section id="contact" class="container contact">
            ...
            <div class="con-menu">
                <div class="con-item">
                    <li><i class="fas fa-user">&nbsp&nbsp</i>Isaac L Songate</li>
                    <li><i class="fas fa-map-marker-alt">&nbsp&nbsp</i>Shanveng, Rengkai, Churachandpur, Manipur.</li>
                    <li><i class="fas fa-envelope">&nbsp&nbsp</i>songate.isaac@gmail.com</li>
                    <li><i class="fas fa-phone">&nbsp&nbsp</i>8721014381</li>
                    <li>Social:
